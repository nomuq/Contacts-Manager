...
open class PopTip: UIView {
  ...
  @objc open dynamic var bubbleColor  = UIColor.red
    ...
    open var colors: [UIColor] = [#colorLiteral(red: 1, green: 1, blue: 1, alpha: 1), #colorLiteral(red: 0, green: 0.7547662854, blue: 0.9446155429, alpha: 1), #colorLiteral(red: 0.2127197087, green: 0.2247233987, blue: 0.2836307287, alpha: 1), #colorLiteral(red: 0.6269891262, green: 0.8749913573, blue: 0.4264523387, alpha: 1), #colorLiteral(red: 0, green: 0.5215578079, blue: 0.9543085694, alpha: 1), #colorLiteral(red: 0.6492791772, green: 0.3526180387, blue: 0.815076828, alpha: 1), #colorLiteral(red: 1, green: 0.8742311597, blue: 0.3319730759, alpha: 1), #colorLiteral(red: 0.8862629533, green: 0.1309023798, blue: 0.1991932988, alpha: 1), #colorLiteral(red: 0.9461943507, green: 0.4014770985, blue: 0.2802144885, alpha: 1), #colorLiteral(red: 0.4002649188, green: 0.7295206189, blue: 0.9158895016, alpha: 1)] {
        didSet {
            if colors.isEmpty {
...
//  @objc open dynamic var cornerRadius = CGFloat(4.0)
  ...
  open override func draw(_ rect: CGRect) {
    ...
    //colors[AppThemes.current.rawValue].setFill()
    ...
    let titleAttributes: [NSAttributedStringKey : Any] = [
      ...
      NSAttributedStringKey.foregroundColor: colors[AppThemes.current.rawValue]
    ]
