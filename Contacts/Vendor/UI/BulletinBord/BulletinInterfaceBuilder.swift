...
@objc open class BulletinInterfaceBuilder: NSObject {
    ...
    @objc open func makeDescriptionLabel() -> UILabel {
        ...
        //descriptionLabel.theme_textColor = ThemeColors.bulletinBordButtonColor
    ...
    @objc open func makeActionButton(title: String) -> HighlightButtonWrapper {
        ...
        actionButton.theme_backgroundColor = ThemeColors.bulletinBordButtonColor
        actionButton.theme_setTitleColor(ThemeColors.bulletinBordTextColor, forState: .normal)
    ...
    @objc open func makeAlternativeButton(title: String) -> HighlightButtonWrapper {

//        let alternativeButton = UIButton(type: .system)
//        alternativeButton.setTitle(title, for: .normal)
//        alternativeButton.theme_backgroundColor = ThemeColors.backgroundColor
//        alternativeButton.theme_setTitleColor(ThemeColors.barTextColor, forState: .normal)
...
//        return alternativeButton
    ...
    @objc open func makeAlternativeSimpleButton(title: String) -> UIButton {
